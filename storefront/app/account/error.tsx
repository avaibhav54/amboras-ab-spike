  ...
  return (
    <div className="container-custom py-16">
      <div className="mx-auto max-w-md text-center">
        ...
        <h2 className="text-xl font-heading font-semibold mb-2">We couldn&apos;t load your account</h2>
        <p className="text-sm text-muted-foreground mb-8">
          Something went wrong fetching your profile. Try again, or return home and sign in once
          more.
        </p>
